...
|===
| *Header* | *Value*
| Access-Control-Allow-Origin | Indicates whether the response can be shared with requesting code from the given origin (server name), can also be specified as a wildcard ‘*’ which allows access from any origin. The value is set to `openliberty.io`
...
| Access-Control-Request-Method | [hotspot=20 file=0]`DELETE`
| Access-Control-Request-Headers | [hotspot=22 file=0]`MyOwnHeader2`
|===
...
|===
| *Header* | *Value*
| Access-Control-Allow-Max-Age | [hotspot=23 file=0]`10`
| Access-Control-Allow-Origin | anywebsiteyoulike.com
| Access-Control-Allow-Methods | [hotspot=20 file=0]`OPTIONS, DELETE`
...
| Access-Control-Allow-Headers | [hotspot=22 file=0]`MyOwnHeader1, MyOwnHeader2`
|===
