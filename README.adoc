...
:page-seo-title: Enabling Cross-Origin Resource Sharing (CORS)
:page-seo-description: A tutorial on how to add two server configurations to enable Cross-Origin Resource Sharing (CORS) and write tests to validate that the CORS configurations work.
...
Open the [hotspot file=1]`CorsIT.java` file in the `src/test/java/it/io/openliberty/guides/cors/` directory.

Now we will test the simple CORS configuration that you added. Add the [hotspot=25-33 file=1]`testSimpleCorsRequest` method to the `CorsIT` class.
...
----
include::finish/src/test/java/it/io/openliberty/guides/cors/CorsIT.java[tags=!comment;!preflightTest]
----
...
[source, java, linenums, role='code_column']
----
include::finish/src/test/java/it/io/openliberty/guides/cors/CorsIT.java[tags=!comment]
----
