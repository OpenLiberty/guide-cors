...
= Enabling CORS in Open Liberty

Learn how to enable CORS in Open Liberty without writing Java(TM) code.
...
The response for the `Access-Control-Allow-Origin` header has a value of `anywebsiteyoulike.com`
...
Congratulations! You enabled CORS support in Open Liberty. You added two different
