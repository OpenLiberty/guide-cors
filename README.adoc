...
| Access-Control-Allow-Origin | Indicates whether the response can be shared with requesting code from the given origin (server name).
| Access-Control-Allow-Credentials | Indicates whether the response can be exposed to the frontend code.
| Access-Control-Expose-Headers | Indicates the HTTP Headers that can be exposed.
|===
...
|===
| *Response Header* | *Response Value*
| Access-Control-Allow-Max-Age | Indicates number of seconds that the preflight request can be cached.
| Access-Control-Allow-Origin | Indicates whether the response can be shared with requesting code from the given origin.
| Access-Control-Allow-Methods | Indicates method(s) allowed when accessing a resource in rsponse to a preflight request. 
| Access-Control-Allow-Credentials | Indicates whether the response can be exposed to the frontend code.
| Access-Control-Allow-Headers | Indicates HTTP headers that can be used during actual request. 
|===
