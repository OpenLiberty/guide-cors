...
| Access-Control-Allow-Origin | The expected response value indicates whether the response can be shared with requesting code from the given origin (server name).
| Access-Control-Allow-Credentials | The expected response value indicates whether the response can be exposed to the frontend code.
| Access-Control-Expose-Headers | The expected response value indicates the HTTP Headers that can be exposed.
|===
...
|===
| *Response Header* | *Response Value*
| Access-Control-Allow-Max-Age | The expected response value indicates number of seconds that the preflight request can be cached.
| Access-Control-Allow-Origin | The expected response value indicates whether the response can be shared with requesting code from the given origin.
| Access-Control-Allow-Methods | The expected response value indicates method(s) allowed when accessing a resource in rsponse to a preflight request. 
| Access-Control-Allow-Credentials | The expected response value indicates whether the response can be exposed to the frontend code.
| Access-Control-Allow-Headers | The expected response value indicates HTTP headers that can be used during actual request. 
|===
