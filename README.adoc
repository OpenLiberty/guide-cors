...
|===
| *Header* | *Value*
| Origin | Server name of where a fetch originates from. The value is set to [hotspot=8 hotspot=26 file=2]`openliberty.io`.
|===
...
|===
| *Header* | *Value*
| Access-Control-Allow-Origin | Indicates whether the response can be shared with requesting code from the given origin (server name). The value is set to [hotspot=13 file=0]`openliberty.io`
