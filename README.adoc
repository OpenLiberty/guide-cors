...
| Access-Control-Allow-Methods | Indicates method(s) allowed when accessing a resource in rsponse to a preflight request. The response value is expected to be [hotspot=20 file=0]`OPTIONS, DELETE`.
