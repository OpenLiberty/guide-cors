...
If you want to learn more configuration, see the https://www.openliberty.io/docs/latest/reference/config/cors.html[Configuration for the Cross-Origin Resource Sharing documentation^] 
